...
THREE.OculusRiftEffect = function ( renderer, side, options ) {
    ...
    if (side == "left"){   left.viewport = [width/2 - HMD.hResolution/2, height/2 - HMD.vResolution/2, HMD.hResolution/2, HMD.vResolution];}
		else{                  right.viewport = [width/2, height/2 - HMD.vResolution/2, HMD.hResolution/2, HMD.vResolution];}
